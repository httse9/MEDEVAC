...
class MEDEVAC(object):
    ...
    def __init__(self,
        ...
        self.gamma_term = gamma_term    # not calculated with method in paper !!!
    ...
    def reset(self):
        ...
        if self.speed == 0:
            ...
            # Fluctuates between 1 lmd and 3 lmd
            self.lmd = (np.sin(self.speed * self.episodes/50) + 2) * self.base_lmd
        ...
        while flag:
            ...
            # if True: 
                ...
                if np.random.rand() < mu/(self.lmd + mu):
                    # A service finishes
                    probs = self.active[:,1] / mu   # no need divide by mu, but same !!!
